"""
Django settings for chest_xray project.
...
from chest_xray import keyconfig as senv
...
SECRET_KEY = 'django-insecure-iks!et(3iy2kgj7m*zjxo@*53y(&z5g-a2d7^xjy+wptwh_ba*'
